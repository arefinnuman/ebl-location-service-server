...
const createDepartment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield department_model_1.Department.create(payload);
    return result;
});
const getAllDepartment = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const whereConditions = andConditions.length > 0
        ...
        : {};
    const result = yield department_model_1.Department.find(whereConditions)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
...
const getSingleDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield department_model_1.Department.findById(id);
    return result;
});
const updateDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield department_model_1.Department.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield department_model_1.Department.findByIdAndDelete(id, { new: true });
    return result;
});

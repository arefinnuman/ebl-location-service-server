...
const createEbl365 = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = __rest(req.body, []);
    const result = yield ebl365_service_1.Ebl365Service.createEbl365(data);
